    ...
    >
      ...
      >
        <motion.div variants={stagger} initial="initial" animate="animate">
          <motion.p
            variants={fadeUp}
            className="mb-5 font-mono text-sm tracking-[0.35em] text-violet-400 uppercase"
          >
            Hello, I&apos;m
          </motion.p>
          ...
          <motion.h1
            variants={fadeUp}
            className="mb-5 text-6xl leading-none font-black tracking-tight sm:text-7xl md:text-9xl"
          >
